...
## get data
adj_label, features, labels, idx_train, idx_val, idx_test = my_load_citation(args.data, 'AugNormAdj', True, args.order)


## Model and optimizer
model = NGMLP(nfeat=features.shape[1],
            nhid=args.hidden,
...
def Ncontrast(x_dis, adj_label, tau = 1):
    ...
    x_dis_sum_pos = torch.sum((1.0-x_dis)*adj_label, 1)
    loss = -torch.log(x_dis_sum_pos).mean()
    return loss
